...
<div class="wrapper">
  ...
  <aside class="sidebar-wrapper" data-simplebar="true">
    <div class="sidebar-header">
      <div>
        <img src="{{ url('assets/images/favicon2.png') }}" class="logo-icon" alt="logo icon">
      </div>
      <div>
        <h4 class="logo-text">PT KM</h4>
      </div>
    ...
    @include('template.AdminNavigation')
    @elseif (Auth()->user()->isAdmin == 'pimpinan')
    @include('template.PimpinanNavigation')
    @else
    @include('template.JamaahNavigation')
    @endif
  </aside>
  <!--end sidebar -->
        ...
        <ul class="navbar-nav align-items-center">
          ...
          <li class="nav-item">
            <a class="nav-link dark-mode-icon" href="javascript:;">
              <div class="mode-icon">
                <ion-icon name="{{ Now()->format('H') >= 16 ? 'sunny-sharp' : 'moon-sharp'  }}"></ion-icon>
              </div>
            </a>
          </li>
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              ...
              <li>
                <form action="{{ url('/logout') }}" method="POST" class="dropdown-item">
                  @csrf
                  <input type="hidden" name="logout" value="erase_session">
                  <div class="d-flex align-items-center">
                    <div class="">
